...
const Home = () => {
  ...
  return (
    <section id="home" className="min-h-[75vh] flex flex-col justify-center relative reveal mt-[-2rem] md:mt-[-4rem]">
      ...
      <div className="hidden lg:flex absolute left-[2%] xl:left-[8%] top-[15%] opacity-10 animate-drift-left pointer-events-none text-white select-none">
        <span className="material-symbols-rounded text-[90px]">android</span>
      </div>
      <div className="hidden lg:flex absolute left-[8%] xl:left-[12%] top-[60%] opacity-5 animate-drift-left-slow pointer-events-none text-white select-none">
        <span className="material-symbols-rounded text-[70px]">smartphone</span>
      </div>
      <div className="hidden lg:flex absolute left-[1%] xl:left-[4%] top-[80%] opacity-[0.07] animate-drift-left pointer-events-none text-white select-none">
        <span className="material-symbols-rounded text-[110px]">code</span>
      </div>

      {/* Right Floating Background Icons */}
      <div className="hidden lg:flex absolute right-[5%] xl:right-[10%] top-[25%] opacity-[0.08] animate-drift-right pointer-events-none text-white select-none">
        <span className="material-symbols-rounded text-[100px]">widgets</span>
      </div>
      <div className="hidden lg:flex absolute right-[10%] xl:right-[15%] top-[65%] opacity-[0.06] animate-drift-right-slow pointer-events-none text-white select-none">
        <span className="material-symbols-rounded text-[80px]">developer_board</span>
      </div>
      <div className="hidden lg:flex absolute right-[2%] xl:right-[6%] top-[85%] opacity-5 animate-drift-right pointer-events-none text-white select-none">
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-8 md:space-y-10">
        ...
        <p className="text-textMuted text-base md:text-xl max-w-2xl mx-auto leading-relaxed px-4">
        ...
        <p className="text-textMuted/60 text-sm md:text-base max-w-xl mx-auto leading-relaxed px-4">
          Real apps. Used by real people
        </p>
        <span className="text-textMuted/50 text-xl animate-[bounce_2s_infinite]">
          ↓
        </span>
      </div>
    </section>
